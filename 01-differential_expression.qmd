...
When you try to push your changes RStudio will probably prompt you for your GitHub username and password. If that works and the push is successful when great, you can skip this chunk, but if you you can quickly set up Git and a PAT token to be able to push your changes.
...
usethis::use_git_config(user.name = "KiranKGR", user.email = "k.guruswamyravindran@surrey.ac.uk")
